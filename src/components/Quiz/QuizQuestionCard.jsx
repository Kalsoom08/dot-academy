  ...
  return (
    <>
      <div className="min-h-screen bg-white">
        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-6 flex flex-col sm:flex-row items-center sm:justify-between gap-4">
          <div className="flex items-center gap-3 text-sm">
            <span className="text-gray-700 font-medium sm:block">Marking scheme:</span>
        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 pb-10">
          <div className="rounded-2xl border border-gray-200 shadow-sm p-4 sm:p-6 md:p-8">
            ...
            <div className="mt-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div className="text-sm text-gray-700 flex flex-wrap gap-4">
                <span className="text-green-600">
                  Correct: <span className="font-semibold">{state.correctCount}</span>
                </span>
                <span className="text-red-400">
                  Incorrect: <span className="font-semibold">{state.incorrectCount}</span>
                </span>
              </div>
              ...
              <div className="flex flex-wrap gap-3">
                ...
                >
                  {state.currentQ + 1 < totalQuestions ? "Next Question" : "Finish"}
                </button>
              </div>
            </div>
          </div>
      ...
      <TestResultPopup
        ...
        onClose={() => setState((prev) => ({ ...prev, showResultPopup: false }))}
