    ...
    >
      ...
      >
        <h1 className="font-bold text-[22px] mb-4">
          Worksheet: {currentLesson?.title || 'Quiz'}
        </h1>
              ...
              >
                ...
                {item.options?.length > 0 && (
                  <div className="flex flex-col gap-2">
                    ...
                    {item.information && (
                      <p className="text-[9px] text-gray-600 italic mt-1 flex items-center gap-1 flex-wrap">
                        The green box
        ...
        >
          <p className="italic text-gray-600">
            ECADEMY DOT is your go-to online learning platform designed to help you learn something valuable every day.
          </p>
          <p className="italic text-gray-600">
            With flexible and affordable subscription plans, you get unlimited access to all learning materials anytime, anywhere.
          </p>
          <motion.button
...
export default WorkSheetDataClient;
