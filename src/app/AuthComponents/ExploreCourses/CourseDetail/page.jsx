...
const courseSections = [
  {
    ...
    items: [
      ...
      { id: 'noun-worksheet', image: course, title: "Worksheet: Noun & its classifications", weight: 'Docs | 2 Pages', type: 'doc' },
      { id: 'noun-worksheet-solution', image: course, title: "Worksheets solution: Noun & its classifications", weight: 'Docs | 5 Pages', type: 'doc' },
      ...
      { id: 'noun-all-about-video', image: course, title: "All About Noun", weight: 'Video | 16:21 min', type: 'video' },
    ]
  },
  {
    title: 'Pronoun',
    ...
    <section className='flex flex-col'>
      ...
      <div className='flex flex-col lg:flex-row px-4 py-10 gap-6'>
            ...
            <div key={index} className='shadow-md shadow-gray-400 rounded-md'>
              ...
              <div
                className={`overflow-hidden transition-all duration-500 ease-in-out px-4 ${
                  activeIndex === index ? 'max-h-[2000px] opacity-100 py-4' : 'max-h-0 opacity-0 py-0'
                } flex flex-col gap-6`}
              >
        ...
        <div className='w-full lg:w-[30%] flex flex-col shadow-md shadow-white px-4 py-6 gap-4 h-fit rounded-md'>
          ...
          <h1 className='text-[18px] md:text-[20px]'>This Course includes</h1>
          <ul className='list-decimal px-6 text-sm space-y-1'>
            <li>20+ videos</li>
            <li>130+ Docs</li>
            <li>10+ Tests</li>
          </ul>
          <button className='border py-2 rounded-md w-full cursor-pointer'>Add to your course</button>
        </div>
      </div>
