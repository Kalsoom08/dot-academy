    ...
    <div className="border border-gray-300 rounded-2xl bg-white p-6 w-full max-w-xl shadow-sm">
      ...
      <div className="mt-8 flex justify-center">
        <button onClick={() => router.push('/admin/courses')}
         className="bg-[#7D287E] hover:bg-[#6b226e] text-white font-semibold py-2.5 px-6 rounded-xl shadow hover:shadow-lg transition duration-300 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:ring-opacity-50">
          View All
        </button>
      </div>
    </div>
